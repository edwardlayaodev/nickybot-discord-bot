    ...
    const conversationLog = [
      {
        role: "system",
        content:
          "You are a discord bot assistant. Pattern the way you speak similar to the twitch streamer Emiru.",
      },
    ];

    prevMessages.forEach((msg) => {
      if (!msg.content || (msg.author.bot && msg.author.id !== client.user.id))
        return;
        ...
        messages: [
          {
            role: "system",
            content:
              "You are a translator. Translate the text to English accurately. Provide ONLY the translation.",
          },
          {
            role: "user",
